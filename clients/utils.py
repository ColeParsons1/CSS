...
def get_templates_dir():
    return os.path.join(BASE_DIR, 'clients/templates' )

def get_clients_dir():
    return os.path.join(BASE_DIR, 'clients/templates', 'clients' )

def get_product_path( aSlug ):
    return os.path.join(BASE_DIR, 'clients/templates', 'clients', aSlug )
...
def get_product( ):
    return get_files( get_clients_dir(), 'json' )
